...
def train(time_chunk_size=10, scale=0.05, nsamples=10):
    ...
    # 8) Plot convergence
    np.savetxt("loss-history-{}-{}.txt".format(nsamples, scale), loss_hist)
...
if __name__ == "__main__":
    ...
    chunk_size, scale, nsamples = 10, 0.05, 30
    ...
    for ik in range(20):
        model, names = train(time_chunk_size=chunk_size, scale=scale, nsamples=nsamples)
        # append the results
    ...
    data.to_csv("res-{}-{}.csv".format(nsamples, scale))
